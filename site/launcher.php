...
if($useban)
{
   ...
   if($stmt->fetchColumn() == 1)
	...
	{	   
		...
		echo Security::encrypt($echo1.str_replace("\\", "/", checkfiles('clients/'.$client.'/bin/').checkfiles('clients/'.$client.'/mods/').checkfiles('clients/'.$client.'/coremods/').checkfiles('clients/assets/objects').checkfiles('clients/assets/indexes').checkfiles('clients/assets/virtual')).$scn_list.'<::>assets<:b:>bin<:b:>mods<:b:>coremods<:b:>', $key1);
